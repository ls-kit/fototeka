    ...
    <div class="container-fluid px-4">
        <div class="card mt-4">
            <div class="card-header">
                <h4 class="">Edit Reportage Gallery</h4>
            </div>
            <div class="card-body">
                ...
                @endif
                    ...
                    @endphp
                <form action="{{ url('admin/reportage/'.$reportage_id.'/update-gallery/'.$gallery->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        @if($gallery->image != null)
                            <img src="{{ asset("uploads/reportage/$reportage_id/$gallery->image") }}" alt="" height="80px" width="80px">
                        @endif
                        <input type="file" name="image" class="form-control">
                    </div>
                    <div class="mb-3">
                        <label>Image with description tag</label>
                        @if($gallery->image != null)
                            <img src="{{ asset("uploads/reportage/$reportage_id/$gallery->image_with_description") }}" alt="" height="80px" width="80px">
                        @endif
