        ...
        <div class="card mt-4">
            ...
            <div class="card-body">
                ...
                @endif
                    ...
                    @endphp
                <form action="{{ url('admin/post/'.$post_id.'/update-gallery/'.$gallery->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        @if($gallery->image != null)
                            <img src="{{ asset("uploads/post/$post_id/$gallery->image") }}" alt="" height="80px" width="80px">
                        @endif
                    ...
                    <div class="mb-3">
                        ...
                        @if($gallery->image_with_description != null)
                            <img src="{{ asset("uploads/post/$post_id/$gallery->image_with_description") }}" alt="" height="80px" width="80px">
                        @endif
