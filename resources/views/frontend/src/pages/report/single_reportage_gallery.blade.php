...
@section('content')
    ...
    <div class="container" style="margin-top: 15px;">
        ...
        <div style="text-align: right;">
            <a href="{!! url('/reportage/'.$gallery->reportage_id)!!}" class="backButton">
                ...
                @lang('text.reportazh_single_back')
            </a>
        </div>

        <div style="align-items: center;display: flex;    justify-content: center;">

            <a href="{!! url("/reportage/$gallery->reportage_id/gallery/$pervious") !!}">
                @include('frontend.layout.left_arrow_single')
            </a>

            <img id="myImg" src="{{ asset('uploads/reportage/'.$gallery->reportage_id.'/'.$gallery->image) }}" data-img-desc="{{ asset('uploads/reportage/'.$gallery->reportage_id.'/'.$gallery->image_with_description) }}"  style="max-height: 70vh;max-width: 80%;">

            <a href="{!! url("/reportage/$gallery->reportage_id/gallery/$next") !!}">
        ...
        <div class="bio-text-images">
            ...
            @if(isset($gallery->meta_data["author_last_name"]["al"]))
                ...
                @if( !empty($gallery->meta_data["author_last_name"]))
                    @if(!is_array($gallery->meta_data["author_last_name"]))
            ...
            @if(isset($gallery->meta_data["title"]["al"]))
                ...
                @if( !empty($gallery->meta_data["title"]))
                    @if(!is_array($gallery->meta_data["title"]))
            ...
            @if(isset($gallery->meta_data["digital_date"]["al"]))
                ...
                @if( !empty($gallery->meta_data["digital_date"]))
                    @if(!is_array($gallery->meta_data["digital_date"]))
            ...
            @if(isset($gallery->meta_data["physic_description"]["al"]))
                ...
                @if( !empty($gallery->meta_data["physic_description"]))
                    @if(!is_array($gallery->meta_data["physic_description"]))
            ...
            @if(isset($gallery->meta_data["width"]["al"]))
                {!! $gallery->meta_data["width"]["al"] !!},
                @if( !empty($gallery->meta_data["width"]))
                    @if(!is_array($gallery->meta_data["width"]))
                        {!! $gallery->meta_data["width"] !!},
                    @endif
                @endif
            @endif
            ...
            @if(isset($gallery->meta_data["height"]["al"]))
                ...
                @if( !empty($gallery->meta_data["height"]))
                    @if(!is_array($gallery->meta_data["height"]))
