...
@section('content')
    ...
    <div class="container" style="margin-top: 15px;">
        ...
        <div style="text-align: right;">
            <a href="{!! url('/author/'.$gallery->author_id)!!}" class="backButton">
        ...
        <div style="align-items: center;display: flex;    justify-content: center;">
            <a href="{!! url("/author/$gallery->author_id/gallery/$pervious") !!}">
                @include('frontend.layout.left_arrow_single')
            </a>

            <img id="myImg" src="{{ asset('uploads/author/'.$gallery->author_id.'/'.$gallery->image) }}" data-img-desc="{{ asset('uploads/author/'.$gallery->author_id.'/'.$gallery->image_with_description) }}"  style="max-height: 70vh;max-width: 80%;">

            <a href="{!! url("/author/$gallery->author_id/gallery/$next") !!}">
